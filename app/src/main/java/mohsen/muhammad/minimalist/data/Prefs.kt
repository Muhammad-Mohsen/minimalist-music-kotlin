...
class Prefs {
    companion object {
        ...
        // current directory
        //
        var currentDirectory = File(FileHelper.ROOT)
            set(directory) {
        ...
        fun getSavedCurrentDirectory(context: Context): File {
            val sharedPreferences = context.getSharedPreferences(MINIMALIST_SHARED_PREFERENCE, Context.MODE_PRIVATE)
            val savedPath = sharedPreferences.getString(
                DIRECTORY_SHARED_PREFERENCE,
                String.EMPTY
            )
        ...
        fun saveCurrentDirectory(context: Context, currentDirectory: File) {
            val sharedPreferences = context.getSharedPreferences(MINIMALIST_SHARED_PREFERENCE, Context.MODE_PRIVATE)
            val editor = sharedPreferences.edit()

            editor.putString(DIRECTORY_SHARED_PREFERENCE, currentDirectory.absolutePath)
            editor.apply()
        }
        //
        // current track
